...
public class FGMessage {
	...
	private static FGMessage mPool;
	 ...
	 */
	public static FGMessage obtain() {
	 ...
	 */
	public static FGMessage obtain(FGMessage orig) {
		FGMessage m = obtain();
		m.what = orig.what;
		m.arg1 = orig.arg1;
		m.arg2 = orig.arg2;
	 ...
	 * @return A Message object from the global pool.
	 */
	public static FGMessage obtain(FGHandler h) {
		FGMessage m = obtain();
		m.target = h;
	 ...
	 * @return A Message object from the global pool.
	 */
	public static FGMessage obtain(FGHandler h, Runnable callback) {
		FGMessage m = obtain();
		m.target = h;
		m.callback = callback;
	 ...
	 * @return A Message object from the global pool.
	 */
	public static FGMessage obtain(FGHandler h, int what) {
		FGMessage m = obtain();
		m.target = h;
		m.what = what;
	 ...
	 * @return A Message object from the global pool.
	 */
	public static FGMessage obtain(FGHandler h, int what, Object obj) {
		FGMessage m = obtain();
		m.target = h;
		m.what = what;
		m.obj = obj;
	 ...
	 * @return A Message object from the global pool.
	 */
	public static FGMessage obtain(FGHandler h, int what, int arg1, int arg2) {
		FGMessage m = obtain();
		m.target = h;
		m.what = what;
		m.arg1 = arg1;
	 ...
	 */
	public void copyFrom(FGMessage o) {
		this.what = o.what;
		this.arg1 = o.arg1;
		this.arg2 = o.arg2;
		this.obj = o.obj;
	...
	public void setTarget(FGHandler target) {
		this.target = target;
	}
