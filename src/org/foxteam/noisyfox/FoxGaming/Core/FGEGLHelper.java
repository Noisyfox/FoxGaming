...
public class FGEGLHelper {
	...
	public final static void bindSurfaceView(SurfaceView view) {
		...
		mBinded_EGL.eglChooseConfig(mBinded_GLDisplay, CONFIGSPEC, configs, 1,
				num_config);
		mBinded_GLConfig = configs[0];

		mBinded_GLSurface = mBinded_EGL.eglCreateWindowSurface(
				mBinded_GLDisplay, mBinded_GLConfig, mBinded_View.getHolder(),
				null);
		...
		mBinded_GL.glClear(GL10.GL_COLOR_BUFFER_BIT | GL10.GL_DEPTH_BUFFER_BIT);
		...
		mBinded_GL.glAlphaFunc(GL10.GL_GREATER, 0.1f); // Set Alpha Testing (To
														// Make Black
														// Transparent)
		...
		mBinded_GL.glBlendFunc(GL10.GL_SRC_ALPHA, GL10.GL_ONE_MINUS_SRC_ALPHA);
