...
/**
 * Vibrate.java A helper class for vibrating the device
 * 
 * REMEMBER TO ADD THE RIGHT PERMISSIONS TO AndroidManifest.xml *
 * <uses-permission android:name="android.permission.VIBRATE"
 * ></uses-permission>
 * 
 * Take care when using import, the name clashes with android.os.Vibrator (yeah,
 * I know.)
 * 
 * @author Richard
 */
...
public class Vibrator {
	...
	/**
	 * Vibrates the phone with a given pattern Pass in an array of ints that are
	 * the times at which to turn on or off the vibrator. The first one is how
	 * long to wait before turning it on, and then after that it alternates. If
	 * you want to repeat, pass the index into the pattern at which to start the
	 * repeat.
	 * 
	 * @param pattern
